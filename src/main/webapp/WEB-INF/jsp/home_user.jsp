        ...
        <div id="headerwrap">
            ...
            <div class="container-fluid">
                <div class="col-sm-3 sidenav">
                    ...
                    <form class="formulario" name="comentarios" method="POST"  action="/BlueRabbit/user/comentar" >
                        <h6>Califica al puesto</h6>
                        <input type="hidden" value="${nombre}" name="puesto">
                        <div class="field-wrap">
                            <input type="number" min="1" max="5" required autocomplete="off" placeholder="Calificación" name="calificacion"/>
                        </div>
